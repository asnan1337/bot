...
/////////////////
const BotName = 'AsnanGans BOT'; 
const instagram = 'https://instagram.com/asnanp29'; 
const whatsapp = 'wa.me/6285866170178'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@asnanp29')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@asnanp29`)
})
